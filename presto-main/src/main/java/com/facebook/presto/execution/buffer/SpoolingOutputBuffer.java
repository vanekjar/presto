        ...
        implements OutputBuffer
{
            ...
            FinalizerService finalizerService)
    {
        ...
        tempDataOperationContext = new TempDataOperationContext(Optional.empty(), Optional.empty(), taskId.getQueryId().toString(), Optional.empty(), Optional.empty(), new Identity("spooling-buffer", Optional.empty()));
